...
public class SPlayerPrefs
{
    ...
    private static string secretKey = "SoWhatTheFuckIAmDoingInThisLife";
    private static byte[] key = new byte[8] { 23, 56, 23, 56, 32, 233, 35, 12 };
    private static byte[] iv = new byte[8] { 88, 23, 63, 95, 34, 74, 6, 218 };
